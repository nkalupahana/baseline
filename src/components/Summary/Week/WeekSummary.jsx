    ...
    */
    ...
    return (
        <div className="week-summary-grid">
            ...
            { logs && logs.length > 0 && <WeekMoodLogList setMenuDisabled={setMenuDisabled} style={{"gridArea": "logs"}} logs={logs} requestedDate={requestedDate} setRequestedDate={setRequestedDate} /> }
