...
const Help = () => {
    return (<>
        <p className="text-center margin-bottom-0">When you're going through hard times, it's important to talk to someone about how you feel. Mood logging is already a great start. If you have 
        ...
        <p className="text-center margin-bottom-0">We also can't recommend therapy enough as a way to process your feelings and find solutions to problems in your life. If you have health insurance, you can likely get therapy cheaply. 
            ...
            email us at <a href="mailto:findhelp@getbaseline.app" target="_blank" rel="noreferrer">findhelp@getbaseline.app</a> &mdash; we're happy to help.
        </p>
        <p className="text-center margin-bottom-0">If you're struggling with money and it's hurting your mental health, you can apply for financial assistance from the baseline Gap Fund.
